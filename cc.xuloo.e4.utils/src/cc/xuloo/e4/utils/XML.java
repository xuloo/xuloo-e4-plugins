...
public class XML {
    ...
    public static Document getDocument(File file) {
        ...
        try {
        	...
        	System.out.println("Parsing error when building Document object from xml file '" + file + "'.");
        } catch (IOException e) {
        	System.out.println("Reading error when building Document object from xml file '" + file + "'.");
    ...
    public static Document getDocument(String xml) {
        ...
        try {
            ...
            System.out.println("Parsing error when building Document object from xml data.");
        } catch (IOException e) {
        	System.out.println("Reading error when building Document object from xml data.");
        } catch (ParserConfigurationException e) {
        	System.out.println("Parsing error when building Document object from xml data.");
        }
        return null;
    ...
    public static boolean validSignature(Document document, Key publicKey) {
        ...
        try {
        	...
        	System.out.println("Error validating an XML signature.");
            return false;
        }
    }
    ...
    public static Document sign(Document document, RSAPublicKey publicKey, RSAPrivateKey privateKey) {
        ...
        try {
        	...
        	System.out.println("Error while signing an XML document.");
        }
